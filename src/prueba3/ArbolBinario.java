...
public class ArbolBinario {
    ...
    public void InOrden(NodoArbol raiz, DefaultTableModel nodos) {
        if (raiz != null) {
            ...
            nodos.addRow(new Object[]{raiz.nombre, raiz.dpi, raiz.NumDosis, raiz.FVacuna1, raiz.FVacuna2, raiz.FVacuna3, raiz.lugVacuna, raiz.depa, raiz.municipio});
    ...
    public boolean MostrarNodoBuscado(long dpi, DefaultTableModel nodos) {
        ...
        if (nodoEncontrado != null) {
            nodos.addRow(new Object[]{nodoEncontrado.nombre, nodoEncontrado.dpi, nodoEncontrado.NumDosis, nodoEncontrado.FVacuna1, nodoEncontrado.FVacuna2, nodoEncontrado.FVacuna3, nodoEncontrado.lugVacuna, nodoEncontrado.depa, nodoEncontrado.municipio});
            return true;
        }
        return false;
    }
